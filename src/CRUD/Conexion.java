...
public class Conexion {
    ...
    public static ResultSet LlenarTabla() throws SQLException{
        try {
            obtener();
    ...
    public static void editarTrabajador(int clave, String name, int sald, int diasl) throws SQLException{
        try {
            obtener();
